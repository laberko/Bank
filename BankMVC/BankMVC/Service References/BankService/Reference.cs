...
namespace BankMVC.BankService {
    ...
    public interface IWcfService {
        ...
        BankMVC.BankService.Transaction[] GetTransactions(int count);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWcfService/GetTransactions", ReplyAction="http://tempuri.org/IWcfService/GetTransactionsResponse")]
        System.Threading.Tasks.Task<BankMVC.BankService.Transaction[]> GetTransactionsAsync(int count);
        ...
        BankMVC.BankService.ATM GetAtmState();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWcfService/GetAtmState", ReplyAction="http://tempuri.org/IWcfService/GetAtmStateResponse")]
        System.Threading.Tasks.Task<BankMVC.BankService.ATM> GetAtmStateAsync();
        ...
        void PutMoneyAsync(BankMVC.BankService.Transaction transaction);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWcfService/PutMoneyAsync", ReplyAction="http://tempuri.org/IWcfService/PutMoneyAsyncResponse")]
        System.Threading.Tasks.Task PutMoneyAsyncAsync(BankMVC.BankService.Transaction transaction);
        ...
        BankMVC.BankService.Transaction GetMoney(int money, bool confirmed);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IWcfService/GetMoney", ReplyAction="http://tempuri.org/IWcfService/GetMoneyResponse")]
        System.Threading.Tasks.Task<BankMVC.BankService.Transaction> GetMoneyAsync(int money, bool confirmed);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IWcfServiceChannel : BankMVC.BankService.IWcfService, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class WcfServiceClient : System.ServiceModel.ClientBase<BankMVC.BankService.IWcfService>, BankMVC.BankService.IWcfService {
        ...
        public BankMVC.BankService.Transaction[] GetTransactions(int count) {
            return base.Channel.GetTransactions(count);
        }
        
        public System.Threading.Tasks.Task<BankMVC.BankService.Transaction[]> GetTransactionsAsync(int count) {
            return base.Channel.GetTransactionsAsync(count);
        }
        
        public BankMVC.BankService.ATM GetAtmState() {
            return base.Channel.GetAtmState();
        }
        
        public System.Threading.Tasks.Task<BankMVC.BankService.ATM> GetAtmStateAsync() {
            return base.Channel.GetAtmStateAsync();
        }
        
        public void PutMoneyAsync(BankMVC.BankService.Transaction transaction) {
            base.Channel.PutMoneyAsync(transaction);
        }
        
        public System.Threading.Tasks.Task PutMoneyAsyncAsync(BankMVC.BankService.Transaction transaction) {
            return base.Channel.PutMoneyAsyncAsync(transaction);
        }
        
        public BankMVC.BankService.Transaction GetMoney(int money, bool confirmed) {
            return base.Channel.GetMoney(money, confirmed);
        }
        
        public System.Threading.Tasks.Task<BankMVC.BankService.Transaction> GetMoneyAsync(int money, bool confirmed) {
